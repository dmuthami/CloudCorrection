...
def writeTIFF(ds,rows,cols,trans,proj,nodatav,npReflectance,outputRasterFile):
    try: 
        ...
        pymsg = "PYTHON ERRORS:\n  Function writeTIFF(ds,rows,cols,trans,proj,nodatav,npReflectance,fileName,outputDirectory) \n" + tbinfo + "\nError Info:\n    " + \
